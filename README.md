...
My name is **Myfer**, and I am a web developer,<br>python developer, CLI developer, graphic designer, and [Twitch streamer.](https://https://twitch.tv/myferontwitch)<br><br>I've been programming for 4 years.<br><br>As a passionate programmer, I take my work very seriously, and as a result of my experience I have gained the following knowledge:
* Python 🐍
* Web Development 💻
* Shell script **>_**
...
<img src="https://skillicons.dev/icons?i=html,css,js,ts,py,java,bash,md">
</p>
<h2 style="text-align:center;"> Frameworks </h2>
<p style="text-align:center;">
<img src="https://skillicons.dev/icons?i=vue,svelte,flask,electron,react">
</p>
<h2 style="text-align:center;"> Tools </h2>
<p style="text-align:center;">
<img src="https://skillicons.dev/icons?i=vscode,vite,npm,nodejs,git,github,cloudflare,vercel,firebase">
</p>
---

I own GitHub swag 🔥
What's that? I was to busy drinking tea from my **Invertocat Mug**.
